...
> الحالة: Milestone 1-3 مكتمل — Milestone 4 قيد التنفيذ
...
| Teacher Student List | أسماء الطلاب + أزرار الحضور (دخول/خروج) | تاريخ التسجيل، العمر |
| Teacher Student Detail | الحضور اليوم (أزرار تلقائية) + الحفظ اليوم | السجل التاريخي الكامل (يفتح بزر) |
...
| Name | Route | Purpose | Layout | Responsive Priority |
|------|-------|---------|--------|---------------------|
| Teacher Dashboard | /teacher/dashboard | نظرة عامة على الطلاب + إحصائيات | TeacherLayout | Desktop-first |
| Student List | /teacher/students | قائمة الطلاب + بحث + أزرار دخول/خروج | TeacherLayout | Desktop-first |
| Student Detail | /teacher/students/:id | تسجيل دخول/خروج تلقائي + حفظ/مراجعة/ملاحظة (modals) | TeacherLayout | Desktop-first |
...
### Teacher Student List (Desktop)

```
┌──────────────────────────────────────────────────────┐
│ [Sidebar]  │ [Header: قائمة الطلاب + بحث]              │
│            ├──────────────────────────────────────────┤
│            │                                          │
│            │ ┌──────────────────────────────────────┐ │
│            │ │  الاسم    | ولي الأمر | الحالة | الحضور│ │
│            │ │  ───────────────────────────────────  │ │
│            │ │  محمد     | أحمد     | نشط   | [دخول] │ │
│            │ │  فاطمة    | أحمد     | نشط   | [خروج] │ │
│            │ │  علي      | سعد     | متوقف  | اكتمل  │ │
│            │ └──────────────────────────────────────┘ │
│            │                                          │
│            │  (الضغط على اسم الطالب → صفحة التفاصيل)   │
│            │  (أزرار الحضور لا تفتح صفحة التفاصيل)     │
└────────────┴──────────────────────────────────────────┘
```

**منطق أزرار الحضور في القائمة:**

| الحالة | ما يظهر | الإجراء |
|--------|---------|---------|
| لا يوجد سجل اليوم | زر "دخول" | POST `{check_in_time: HH:MM:SS}` |
| دخل ولم يخرج | زر "خروج" | PATCH `{check_out_time: HH:MM:SS}` |
| دخل وخرج | Badge "اكتمل" | لا شيء |
